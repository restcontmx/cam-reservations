...
class ReservationListCreateAPIView( generics.ListCreateAPIView, SecuritySystem ) :
...
class ReservationRetrieveUpdateDestroyAPIView( generics.RetrieveUpdateDestroyAPIView, SecuritySystem ) :
